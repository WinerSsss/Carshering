# Generated by Django 4.0.6 on 2023-06-25 12:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='carservice.car', validators=[carservice.models.car_available])),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='carservice.offer', validators=[carservice.models.offer_available])),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
