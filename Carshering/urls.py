...
from carservice.views import CarCreateView, CarReadView, OfferReadView, OfferCreateView, RentCreateView, RentListView, \
    CarUpdateView, CarDeleteView, OfferUpdateView, OfferDeleteView, RentUpdateView, RentDeleteView, CarSearchView
...
urlpatterns = [
    ...
    path('carsearch/', CarSearchView.as_view(), name='carsearch'),
